...
| *Data Science* | Pandas, NumPy, SciPy, Matplotlib, Seaborn, Power BI, Excel, Scikit-learn |
| *Deep Learning* | TensorFlow, Keras, PyTorch, CNNs, ViT, NLP (NLTK, spaCy) |
| *Spatial Analysis* | Leaflet, ggplot2, sf, geodata, Choropleth Mapping |
| *Web & Tools* | React, Node.js, Streamlit, HTML/CSS, GitHub, Jupyter |
